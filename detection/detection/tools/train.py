...
def make_parser():
    ...
    parser.add_argument(
        "-b", "--batch_size", default=8, type=int, help="batchsize for training",
    )
    parser.add_argument(
        "-d", "--dataset_dir", default="./", type=str,
    )
